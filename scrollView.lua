--I (Sara) borrowed this code from: https://developer.coronalabs.com/code/scroll-content
--It sets up a scroll bar that allows users to swipe down through a long visualization
--The comments are from the original author unless otherwise noted.
...
function new(params)
        ...
        --Comment from Sara: this function seems to not work for me in that I am unable to change the color of the scrollbar. Something to look into.
 ...
 --Comment from Sara: Is the scrollbar necessary? Do users need to see it in order to scroll?
